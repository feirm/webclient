<template>
    <div class="min-h-screen flex items-center justify-center bg-grey-500">
        <div class="bg-gray-100 p-8 shadow-2xl sm:w-1/2 md:w-1/2 lg:w-1/4 sm:rounded md:rounded lg:rounded sm:h-full md:h-full lg:h-full">
            ...
            <h1 class="text-3xl font-light mb-4 text-center">Unlock your account 🔒</h1>
            <p class="font-light mb-3">Please enter your encryption key to unlock your Feirm account.</p>
            ...
            <!-- Decrypt button -->
            <button class="block w-full bg-orange-500 hover:bg-orange-400 p-4 rounded text-yellow-900 transition duration-300" @click="decrypt()">
