      ...
      <div class="xl:grid xl:grid-cols-3 xl:gap-8">
        <div class="space-y-8 xl:col-span-1">
          ...
          <p class="text-gray-500 text-base">
            An all in one cryptocurrency platform that provides privacy for everyone.
          </p>
          ...
          <div class="md:grid md:grid-cols-2 md:gap-8">
            <div>
              ...
              <ul class="mt-4 space-y-4">
                <li v-for="item in navigation.feirm" :key="item.name">
...
const navigation = {
  ...
  company: [
    ...
    { name: 'Blog', href: 'https://medium.com/feirm' }
  ],
  legal: [
    { name: 'Privacy', href: 'https://feirm.com/privacy' },
    { name: 'Terms', href: 'https://feirm.com/terms' }
  ],
  social: [
    {
      name: 'Instagram',
      href: 'https://instagram.com/_feirm',
