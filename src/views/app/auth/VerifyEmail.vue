<template>
  ...
  >
    ...
    >
      ...
      <div>
        <h2 class="text-3xl font-light mb-5 text-center">
        ...
        <img
          v-show="verified"
          class="mx-auto w-24"
          src="@/assets/check_tick.svg"
          alt="Checkmark"
        />
        <p v-show="verified" class="text-center mt-5">
          Your email has been verified! Feel free to close this tab.
        </p>
      </div>
    </div>
  </div>
